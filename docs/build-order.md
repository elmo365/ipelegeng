...
worked through in [`architecture.md`](architecture.md#calling--two-routes-and-why-not-matrix).
**Both routes are planned** —
...
feature. Matrix is the wrong shape and the architecture doc says why. The design work is in
